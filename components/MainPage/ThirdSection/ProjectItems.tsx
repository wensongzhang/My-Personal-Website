...
function ProjectItems({
    ...
    return (
        <article className="project-item flex cursor-default flex-col gap-6 px-14 transition-all  ">
            ...
            <div className="project-hide w-fit text-primary-100 text-4xl text-left font-bold">
                {title}
            </div>
            <p className="project-hide flex-1 text-justify text-primary-100 ">
                {description}
            </p>
            <ul className="project-hide flex flex-wrap gap-4 text-teal-300 font-bold">{stack}</ul>
